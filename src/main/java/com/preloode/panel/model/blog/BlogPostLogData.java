...
public class BlogPostLogData extends Base {
    ...
    public BlogPostLogData() {


    }


    public BlogPostLogData(String id, TimestampReference created, TimestampReference modified, String blogPostId, CategoryMultipleReference category, CompanyListReference company, String content, String description, BigInteger dislike, boolean featured, List<String> imageList, BigInteger like, MetaReference meta, OgReference og, List<String> pathList, BigDecimal rate, BigInteger sequence, BlogStarReference star, Status status, List<String> tagList, List<String> thumbnailList, String title, BlogType type, String url, List<String> videoList, BigInteger view) {
