...
public class PaymentAccountLogData extends Base {
    ...
    public PaymentAccountLogData() {


    }


    public PaymentAccountLogData(String id, TimestampReference created, TimestampReference modified, String branch, CompanyListReference company, BigDecimal credit, String description, PaymentMethodReference method, String name, String number, String password, String paymentAccountId, String pin, String qrCode, BigInteger sequence, Status status, String username) {
