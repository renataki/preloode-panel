...
public class ShopProduct extends Base {
    ...
    public ShopProduct(String id, TimestampReference created, TimestampReference modified, ShopBrandReference brand, CategoryMultipleReference category, CompanyListReference company, String description, BigInteger dislike, boolean featured, String guide, List<String> imageList, String information, BigInteger like, MetaReference meta, String name, OgReference og, List<String> pathList, ShopProductPriceReference price, BigDecimal rate, boolean recurring, BigInteger sequence, String sku, Status status, BigInteger stock, boolean storage, List<String> tagList, List<String> thumbnailList, ProductType type, String url, ShopProductVariantReference variant, BigInteger view) {
