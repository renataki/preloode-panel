...
public class ShopProductVariantPriceOneTimeReference {
    ...
    public ShopProductVariantPriceOneTimeReference() {


    }


    public ShopProductVariantPriceOneTimeReference(List<BigDecimal> discountList, List<BigDecimal> normalList) {
