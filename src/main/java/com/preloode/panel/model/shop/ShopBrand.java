...
public class ShopBrand extends Base {
    ...
    public ShopBrand(String id, TimestampReference created, TimestampReference modified, CategoryMultipleReference category, CompanyListReference company, String content, String description, BigInteger dislike, List<String> imageList, BigInteger like, MetaReference meta, String name, OgReference og, String path, BigDecimal rate, BigInteger sequence, Status status, List<String> thumbnailList, String url, BigInteger view) {
