...
public class ShopBrandLogData extends Base {
    ...
    public ShopBrandLogData() {


    }


    public ShopBrandLogData(String id, TimestampReference created, TimestampReference modified, CategoryMultipleReference category, CompanyListReference company, String content, String description, BigInteger dislike, List<String> imageList, BigInteger like, MetaReference meta, String name, OgReference og, String path, BigDecimal rate, BigInteger sequence, String shopBrandId, Status status, List<String> thumbnailList, String url, BigInteger view) {
