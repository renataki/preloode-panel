...
public class ShopCategory extends Base {
    ...
    public ShopCategory(String id, TimestampReference created, TimestampReference modified, CompanyListReference company, String content, String description, BigInteger dislike, List<String> imageList, BigInteger like, MetaReference meta, String name, OgReference og, ShopCategoryParentReference parent, String path, BigDecimal rate, BigInteger sequence, Status status, List<String> thumbnailList, String url, BigInteger view) {
