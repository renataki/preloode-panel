...
public class CrmGroup extends Base {
    ...
    public CrmGroup(String id, TimestampReference created, TimestampReference modified, CompanyListReference company, String description, String name, BigInteger sequence, Status status, UserGroupListReference userGroup) {
