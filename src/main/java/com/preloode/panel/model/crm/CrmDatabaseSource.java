...
public class CrmDatabaseSource extends Base {
    ...
    public CrmDatabaseSource(String id, TimestampReference created, TimestampReference modified, CompanyListReference company, String description, String name, BigInteger sequence, Status status) {
