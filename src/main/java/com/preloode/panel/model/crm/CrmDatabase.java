...
public class CrmDatabase extends Base {
    ...
    public CrmDatabase(String id, TimestampReference created, TimestampReference modified, List<BigInteger> attemptList, String city, CompanyListReference company, ContactReference contact, Country country, Gender gender, CrmGroupReference group, Language language, NameReference name, String reference, CrmDatabaseSourceReference source, String state, CrmDatabaseStatus status, String streetAddress, CrmDatabaseType type, UserReference user, String zipCode) {
