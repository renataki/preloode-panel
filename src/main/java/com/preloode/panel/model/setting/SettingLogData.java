...
public class SettingLogData extends Base {
    ...
    private SettingMembershipReference membership;
    ...
    public SettingLogData() {


    }


    public SettingLogData(String id, TimestampReference created, TimestampReference modified, SettingActivationReference activation, SettingTransactionReference addToCart, SettingTransactionReference adjustment, SettingTransactionReference checkout, String city, ContactReference contact, Country country, SettingTransactionReference deposit, String description, SettingTransactionReference expense, String favicon, SettingTransactionReference fee, SettingTransactionReference internal, SwitchReference like, String logo, SettingMaintenanceReference maintenance, SettingMembershipReference membership, MetaReference meta, String name, OgReference og, SwitchReference rating, String registrationNumber, SwitchReference review, String settingId, String state, ApplicationStatus status, String streetAddress, SettingTransactionReference transfer, SettingTransactionReference withdrawal, String zipCode) {
    ...
    public SettingMembershipReference getMembership() {
    ...
    public void setMembership(SettingMembershipReference membership) {
