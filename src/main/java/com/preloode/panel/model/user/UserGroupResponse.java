...
public class UserGroupResponse extends BaseResponse {
    ...
    public UserGroupResponse(String response, boolean result, List<CompanyBranch> companyBranchList, List<Company> companyList, Map<String, Object> filter, String link, int page, int size, List<Status> statusList, UserGroup userGroup, List<UserGroup> userGroupList, List<UserType> userTypeList) {
