...
public class ThirdPartyAccountLogData extends Base {
    ...
    public ThirdPartyAccountLogData() {


    }


    public ThirdPartyAccountLogData(String id, TimestampReference created, TimestampReference modified, CompanyListReference company, BigDecimal credit, String description, String password, String pin, ThirdPartyProviderReference provider, BigInteger sequence, Status status, String username, String thirdPartyAccountId) {
