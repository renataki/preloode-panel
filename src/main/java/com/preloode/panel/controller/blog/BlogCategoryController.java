...
import com.preloode.panel.service.blog.BlogCategoryService;
...
public class BlogCategoryController {
    ...
    public GlobalConfiguration global(HttpServletRequest request) {
        ...
        global.initializeSetting(request, "Blog Category");
    ...
    public String index(HttpServletRequest request, Model model) {
        ...
        if(!checkLogin.isEmpty()) {
            ...
            BaseResponse checkPrivilege = userService.checkPrivilege("view", account.getPrivilege().getBlogCategory());

            if(checkPrivilege.isResult()) {

                page = 1;

                BlogCategoryResponse blogCategoryPagination = blogCategoryService.loadPagination(request, account, Sort.Direction.DESC, "created.timestamp", page);

                if(blogCategoryPagination.isResult()) {

                    model.addAttribute("link", blogCategoryPagination.getLink());
                    model.addAttribute("page", page);
                    model.addAttribute("pagination", blogCategoryPagination.getBlogCategoryList());

                }

                logger.info("Blog category page initialized");
    ...
    public String add(HttpServletRequest request, Model model) {
        ...
        if(!checkLogin.isEmpty()) {
            ...
            BaseResponse checkPrivilege = userService.checkPrivilege("add", account.getPrivilege().getBlogCategory());

            if(checkPrivilege.isResult()) {

                model.addAttribute("entry", new BlogCategory());

                logger.info("Blog category entry page initialized");

                return "blog/category-entry";
    ...
    public String edit(HttpServletRequest request, @PathVariable("id") String id, Model model) {
        ...
        if(!checkLogin.isEmpty()) {
            ...
            BaseResponse checkPrivilege = userService.checkPrivilege("edit", account.getPrivilege().getBlogCategory());

            if(checkPrivilege.isResult()) {

                model.addAttribute("entry", blogCategoryService.loadEntry(id.replaceAll("[^A-Za-z0-9]", "")));
    ...
    @ResponseBody
    public BlogCategoryResponse initializePagination(HttpServletRequest request) {
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.initializePagination(request, account, page);
    ...
    public BaseResponse filterPagination(HttpServletResponse response, @RequestBody Map<String, Object> filter) {
        ...
        BaseResponse result = new BaseResponse(
                "Failed to filter blog category pagination",
                false
        );
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.filterPagination(response, account, filter);
    ...
    public BaseResponse setPagination(HttpServletResponse response, @RequestBody int pagination) {
        ...
        BaseResponse result = new BaseResponse(
                "Failed to set blog category pagination",
                false
        );
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.setPagination(response, account, pagination);
    ...
    public BaseResponse removeFilterPagination(HttpServletRequest request, HttpServletResponse response) {
        ...
        BaseResponse result = new BaseResponse(
                "Failed to remove filter blog category pagination",
                false
        );
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.removeFilterPagination(request, response, account);
    ...
    @ResponseBody
    public BlogCategoryResponse initializeData(@RequestBody String id) {
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.initializeData(account, id);
    ...
    public FileResponse uploadImageList(MultipartHttpServletRequest multipartRequest) {
        ...
        FileResponse result = new FileResponse() {
            {
                setResponse("Failed to upload blog category image list");
                setResult(false);
            }
        };
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = file.uploadResizeImage(multipartRequest, FileSize.Large, "/blog/category");
    ...
    public FileResponse uploadThumbnailList(MultipartHttpServletRequest multipartRequest) {
        ...
        FileResponse result = new FileResponse() {
            {
                setResponse("Failed to upload blog category thumbnail list");
                setResult(false);
            }
        };
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = file.uploadResizeImage(multipartRequest, FileSize.Medium, "/blog/category/thumbnail");
    ...
    public FileResponse uploadTinymce(MultipartHttpServletRequest multipartRequest) {
        ...
        FileResponse result = new FileResponse() {
            {
                setResponse("Failed to upload blog category tinymce");
                setResult(false);
            }
        };
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = file.uploadResizeTinymceImage(multipartRequest, "/blog/category/tinymce");
    ...
    @ResponseBody
    public BaseResponse insert(HttpServletRequest request, @RequestBody BlogCategory blogCategory) {
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.insert(request, account, blogCategory);
    ...
    @ResponseBody
    public BaseResponse update(HttpServletRequest request, @RequestBody BlogCategory blogCategory) {
        ...
        if(account.getUsername() != null) {
            ...
            if(checkPrivilege.isResult()) {
                ...
                result = blogCategoryService.update(request, account, blogCategory);
    ...
    public BaseResponse delete(HttpServletRequest request, @RequestBody String id) {
        ...
        if(account.getUsername() != null) {
            ...
            BaseResponse checkPrivilege = userService.checkPrivilege("delete", account.getPrivilege().getBlogCategory());

            if(checkPrivilege.isResult()) {

                result = blogCategoryService.delete(request, account, id);
