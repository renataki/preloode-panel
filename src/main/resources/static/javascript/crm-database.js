app.controller("crmDatabase", ["$scope", "$window", "global", function($scope, $window, global) {
    ...
    $scope.delete = function(id, event) {
        ...
        var rest = {
            "data": id,
            "url": document.getElementById("global").getAttribute("data-base-url") + "/crm/database/delete"
        };
