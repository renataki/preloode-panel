app.controller("company", ["$scope", "$window", "global", function($scope, $window, global) {
    ...
    $scope.delete = function(id, event) {
        ...
        var rest = {
            "data": id,
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/delete"
        };
    ...
    $scope.edit = function(event) {
        ...
        if(valid) {
            ...
            var rest = {
                ...
                "url": document.getElementById("global").getAttribute("data-base-url") + "/company/update"
            };
            global.rest(rest, function(response) {
    ...
    $scope.filterPagination = function(event) {
        ...
        var rest = {
            "data": data,
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/filter-pagination"
        };
        global.rest(rest, function(response) {

            if(response.result) {

                $window.location.href = document.getElementById("global").getAttribute("data-base-url") + "/company/";
    ...
    $scope.forceUploadFavicon = function() {
        ...
        document.getElementsByClassName("company-favicon")[0].click();
    ...
    $scope.forceUploadLogo = function() {
        ...
        document.getElementsByClassName("company-logo")[0].click();
    ...
    $scope.goToPage = function(event) {
        ...
        if(event.which == 13) {
            ...
            $window.location.href = document.getElementById("global").getAttribute("data-base-url") + "/company/page-" + $scope.site.page.number + "/";
    ...
    $scope.initializeData = function(id) {
        ...
        var rest = {
            "data": id,
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/initialize-data"
        };
        global.rest(rest, function(response) {

            if(response.result) {

                if(response.company.id != null) {

                    $scope.activation.email.value = response.company.activation.email;
                    $scope.activation.sms.value = response.company.activation.sms;
                    $scope.addToCart.amount.maximum.value = library.numeral.initializeSeparator(response.company.addToCart.maximum, true);
                    $scope.addToCart.amount.minimum.value = library.numeral.initializeSeparator(response.company.addToCart.minimum, true);
                    $scope.addToCart.averageTime.value = library.numeral.initializeSeparator(response.company.addToCart.averageTime, true);
                    $scope.adjustment.amount.maximum.value = library.numeral.initializeSeparator(response.company.adjustment.maximum, true);
                    $scope.adjustment.amount.minimum.value = library.numeral.initializeSeparator(response.company.adjustment.minimum, true);
                    $scope.adjustment.averageTime.value = library.numeral.initializeSeparator(response.company.adjustment.averageTime, true);
                    $scope.checkout.amount.maximum.value = library.numeral.initializeSeparator(response.company.checkout.maximum, true);
                    $scope.checkout.amount.minimum.value = library.numeral.initializeSeparator(response.company.checkout.minimum, true);
                    $scope.checkout.averageTime.value = library.numeral.initializeSeparator(response.company.checkout.averageTime, true);
                    $scope.city.value = response.company.city;
                    $scope.contact.emailAddress.value = response.company.contact.emailAddress;
                    $scope.contact.lineId.value = response.company.contact.lineId;
                    $scope.contact.wechatId.value = response.company.contact.wechatId;

                    var createdTimestamp = new Date(response.company.created.timestamp);
                    ...
                    $scope.created.user.id.value = response.company.created.user.id;
                    $scope.created.user.username.value = response.company.created.user.username;
                    $scope.deposit.amount.maximum.value = library.numeral.initializeSeparator(response.company.deposit.maximum, true);
                    $scope.deposit.amount.minimum.value = library.numeral.initializeSeparator(response.company.deposit.minimum, true);
                    $scope.deposit.averageTime.value = library.numeral.initializeSeparator(response.company.deposit.averageTime, true);
                    $scope.description.value = response.company.description;
                    $scope.expense.amount.maximum.value = library.numeral.initializeSeparator(response.company.expense.maximum, true);
                    $scope.expense.amount.minimum.value = library.numeral.initializeSeparator(response.company.expense.minimum, true);
                    $scope.expense.averageTime.value = library.numeral.initializeSeparator(response.company.expense.averageTime, true);

                    if(response.company.favicon != "") {

                        $scope.favicon.value = response.company.favicon;
                        $scope.favicon.upload.file = response.company.favicon;
                        $scope.favicon.upload.view = true;

                    }

                    $scope.fee.amount.maximum.value = library.numeral.initializeSeparator(response.company.fee.maximum, true);
                    $scope.fee.amount.minimum.value = library.numeral.initializeSeparator(response.company.fee.minimum, true);
                    $scope.fee.averageTime.value = library.numeral.initializeSeparator(response.company.fee.averageTime, true);
                    $scope.id.value = response.company.id;
                    $scope.internal.amount.maximum.value = library.numeral.initializeSeparator(response.company.internal.maximum, true);
                    $scope.internal.amount.minimum.value = library.numeral.initializeSeparator(response.company.internal.minimum, true);
                    $scope.internal.averageTime.value = library.numeral.initializeSeparator(response.company.internal.averageTime, true);
                    $scope.like.blog.value = response.company.like.blog;
                    $scope.like.shop.value = response.company.like.shop;

                    if(response.company.logo != "") {

                        $scope.logo.value = response.company.logo;
                        $scope.logo.upload.file = response.company.logo;
                        $scope.logo.upload.view = true;

                    }

                    var maintenanceFinish = new Date(response.company.maintenance.finish);
                    ...
                    var maintenanceNext = new Date(response.company.maintenance.next);
                    ...
                    $scope.meta.description.value = response.company.meta.description;
                    $scope.meta.keyword.value = response.company.meta.keyword;
                    $scope.meta.title.value = response.company.meta.title;

                    var modifiedTimestamp = new Date(response.company.modified.timestamp);
                    ...
                    $scope.modified.user.id.value = response.company.modified.user.id;
                    $scope.modified.user.username.value = response.company.modified.user.username;
                    $scope.name.value = response.company.name;
                    $scope.og.description.value = response.company.og.description;
                    $scope.og.title.value = response.company.og.title;
                    $scope.rating.blog.value = response.company.rating.blog;
                    $scope.rating.shop.value = response.company.rating.shop;
                    $scope.registrationNumber.value = response.company.registrationNumber;
                    $scope.review.blog.value = response.company.review.blog;
                    $scope.review.shop.value = response.company.review.shop;
                    $scope.sequence.value = library.numeral.initializeSeparator(response.company.sequence, true);
                    $scope.state.value = response.company.state;
                    $scope.streetAddress.value = response.company.streetAddress;
                    $scope.transfer.amount.maximum.value = library.numeral.initializeSeparator(response.company.transfer.maximum, true);
                    $scope.transfer.amount.minimum.value = library.numeral.initializeSeparator(response.company.transfer.minimum, true);
                    $scope.transfer.averageTime.value = library.numeral.initializeSeparator(response.company.transfer.averageTime, true);
                    $scope.withdrawal.amount.maximum.value = library.numeral.initializeSeparator(response.company.withdrawal.maximum, true);
                    $scope.withdrawal.amount.minimum.value = library.numeral.initializeSeparator(response.company.withdrawal.minimum, true);
                    $scope.withdrawal.averageTime.value = library.numeral.initializeSeparator(response.company.withdrawal.averageTime, true);
                    $scope.zipCode.value = response.company.zipCode;
                ...
                angular.forEach(response.applicationStatusList, function(value, key) {
                    ...
                    if(response.company.id != null) {
                        ...
                        if(value == response.company.status) {
                ...
                angular.forEach(response.countryCodeList, function(value, key) {
                    ...
                    if(response.company.id != null) {
                        ...
                        if(response.company.contact.faxNumber.startsWith(value)) {

                            $scope.contact.faxNumber.countryCode.selected = $scope.contact.faxNumber.countryCode.option[key];
                            $scope.contact.faxNumber.value = response.company.contact.faxNumber.replace(value, "");

                        }

                        if(response.company.contact.phoneNumber.startsWith(value)) {

                            $scope.contact.phoneNumber.countryCode.selected = $scope.contact.phoneNumber.countryCode.option[key];
                            $scope.contact.phoneNumber.value = response.company.contact.phoneNumber.replace(value, "");

                        }

                        if(response.company.contact.whatsappNumber.startsWith(value)) {

                            $scope.contact.whatsappNumber.countryCode.selected = $scope.contact.whatsappNumber.countryCode.option[key];
                            $scope.contact.whatsappNumber.value = response.company.contact.whatsappNumber.replace(value, "");
                ...
                angular.forEach(response.countryList, function(value, key) {
                    ...
                    if(response.company.id != null) {
                        ...
                        if(value == response.company.country) {
    ...
    $scope.initializePagination = function() {
        ...
        var rest = {
            "data": "",
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/initialize-pagination"
        };
        global.rest(rest, function(response) {
            ...
            if(response.result) {
                ...
                if(Object.entries(response.filter).length > 0) {
                    ...
                    angular.forEach($scope.filter.country.option, function(value, key) {
                        ...
                        if(value.value == response.filter.country[1]) {
    ...
    $scope.insert = function(event) {
        ...
        if(valid) {
            ...
            var rest = {
                ...
                "url": document.getElementById("global").getAttribute("data-base-url") + "/company/insert"
            };
            global.rest(rest, function(response) {
        ...
        global.rest(rest, function(response) {
            ...
            if(response.result) {
                ...
                if(response.company.id != null) {
                    ...
                    $scope.city.value = response.company.city;
                    $scope.contact.emailAddress.value = response.company.contact.emailAddress;
                    $scope.contact.faxNumber.value = response.company.contact.faxNumber;
                    $scope.contact.lineId.value = response.company.contact.lineId;
                    $scope.contact.phoneNumber.value = response.company.contact.phoneNumber;
                    $scope.contact.whatsappNumber.value = response.company.contact.whatsappNumber;
                    $scope.contact.wechatId.value = response.company.contact.wechatId;
                    $scope.country.value = $scope.camelCaseToStandardCase(response.company.country);
                    ...
                    if(response.company.favicon != "") {
                        ...
                        $scope.favicon.upload.file = document.getElementById("global").getAttribute("data-image-url") + "/setting/" + response.company.favicon;
                        $scope.favicon.upload.view = true;
                    ...
                    if(response.company.logo != "") {
                        ...
                        $scope.logo.upload.file = document.getElementById("global").getAttribute("data-image-url") + "/setting/" + response.company.logo;
                        $scope.logo.upload.view = true;
                    ...
                    $scope.sequence.value = library.numeral.initializeSeparator(response.company.sequence, true);
                    $scope.state.value = response.company.state;
                    $scope.status.value = $scope.camelCaseToStandardCase(response.company.status);
                    $scope.streetAddress.value = response.company.streetAddress;
                    $scope.transfer.amount.maximum.value = library.numeral.initializeSeparator(response.company.transfer.maximum, true);
                    $scope.transfer.amount.minimum.value = library.numeral.initializeSeparator(response.company.transfer.minimum, true);
                    $scope.transfer.averageTime.value = library.numeral.initializeSeparator(response.company.transfer.averageTime, true);
    ...
    $scope.removeFilterPagination = function(event) {
        ...
        var rest = {
            "data": "",
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/remove-filter-pagination"
        };
        global.rest(rest, function(response) {
    ...
    $scope.setPagination = function(event) {
        ...
        var rest = {
            ...
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/set-pagination"
        };
        global.rest(rest, function(response) {
    ...
    $scope.uploadFavicon = function(index) {
        ...
        var rest = {
            "data": formData,
            "url": document.getElementById("global").getAttribute("data-base-url") + "/company/upload-image"
        };
...
app.directive("companyDetail", function() {
    ...
    company.templateUrl = document.getElementById("global").getAttribute("data-base-url") + "/html/company-detail-popup.html";
...
app.directive("companyFaviconPreview", function() {


    var company = {};


    company.template = "<span ng-if=\"favicon.upload.file != ''\">" +
...
app.directive("companyLogoPreview", function() {


    var company = {};


    company.template = "<span ng-if=\"logo.upload.file != ''\">" +
